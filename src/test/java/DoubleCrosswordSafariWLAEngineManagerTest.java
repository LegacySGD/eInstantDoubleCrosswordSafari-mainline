...
public class DoubleCrosswordSafariWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(DoubleCrosswordSafariWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/DoubleCrosswordSafariIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/DoubleCrosswordSafariIW/InitOutcome.xml").getDocumentElement();
